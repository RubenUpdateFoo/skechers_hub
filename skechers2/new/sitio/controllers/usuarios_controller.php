...
class UsuariosController extends AppController
{
  ...
  function app_buscar_producto()
  {
   ...
   $coneccion = $this->Producto->find('all',array('fields'=> array('Producto.codigo','Producto.nombre','Producto.precio'),
...
function app_foo(){
        Configure::write('debug',1);
           ...
           $test1 = array(array('reporte_id'  => 2,
                                  'pregunta_id' => 3,
                                   'valor'      =>  'primer dato valor'),
                            array('reporte_id'  => 3,
                                  'pregunta_id' => 4,
                                   'valor'      =>  'segundo dato valor')) ;
         
          $result = Set::sort($test1, '{n}.valor', 'asc');

          /*ordenar array*/
           // $a = array( 0 => array('Person' => array('name' => 'Jeff')),
           ...
           prx($result);
            ...
            foreach($test1 as $index => $respuesta)
            {
              $test1[$index]['LALA_id'] = 'lala';
