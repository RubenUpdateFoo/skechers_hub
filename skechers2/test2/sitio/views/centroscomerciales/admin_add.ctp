<div class="col02">
	<?= $this->Form->create('Centroscomercial', array('type' => 'file', 'inputDefaults' => array('class' => 'clase-input', 'div' => false, 'label' => array('class' => 'texto')))); ?>
 	<h1 class="titulo"><? __('Agregar Centroscomercial'); ?></h1>
	<ul class="edit">
