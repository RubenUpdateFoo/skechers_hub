...
{
	var $name = 'Centroscomerciales';

	function admin_index()
	{
		$this->Centroscomercial->recursive = 0;
		$this->set('centroscomerciales', $this->paginate());
	}
	...
	function admin_view($id = null)
	{
		...
		$this->set('centroscomercial', $this->Centroscomercial->read(null, $id));
	}
	...
	function admin_add()
	{
		if ( ! empty($this->data) )
		{
			$this->Centroscomercial->create();
			if ( $this->Centroscomercial->save($this->data) )
			{
	...
	function admin_edit($id = null)
	{
		...
		if ( empty($this->data) )
		{
			$this->data = $this->Centroscomercial->read(null, $id);
		}
	}
	...
	function admin_delete($id = null)
	{
		...
		if ( $this->Centroscomercial->delete($id) )
		{
