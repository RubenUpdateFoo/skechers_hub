<div class="col02">
	...
	<div class="previsualizar">
		<ul>
			<li><span><? __('Centroscomercial'); ?>:</span><p><?= $this->Html->link($local['Centroscomercial']['id'], array('controller' => 'centroscomerciales', 'action' => 'view', $local['Centroscomercial']['id'])); ?>&nbsp;</p></li>
			<li><span><? __('Tienda'); ?>:</span><p><?= $this->Html->link($local['Tienda']['id'], array('controller' => 'tiendas', 'action' => 'view', $local['Tienda']['id'])); ?>&nbsp;</p></li>
