...
class Local extends AppModel
{
	...
	*/
	...
	// ASOCIACIONES
	var $belongsTo = array(
		'Centroscomercial' => array(
			'className'				=> 'Centroscomercial',
			'foreignKey'			=> 'centroscomercial_id',
			'conditions'			=> '',
			'fields'				=> '',
			'order'					=> '',
			'counterCache'			=> false,
			'counterScope'			=> array('Asociado.modelo' => 'Centroscomercial')
		),
		'Tienda' => array(
			'className'				=> 'Tienda',
	...
	var $hasMany = array(
		'Localesusuario' => array(
			'className'				=> 'Localesusuario',
			'foreignKey'			=> 'local_id',
			'dependent'				=> false,
			'conditions'			=> '',
			'fields'				=> '',
