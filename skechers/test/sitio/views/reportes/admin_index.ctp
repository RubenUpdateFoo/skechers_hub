<div class="col02">
	...
	<table cellpadding="0" cellspacing="0" class="tabla">
		...
		<tr>
			<td><?= $this->Html->link($reporte['Foto']['id'], array('controller' => 'fotos', 'action' => 'view', $reporte['Foto']['id'])); ?></td>
			<td><?= $this->Html->link($reporte['Usuario']['id'], array('controller' => 'usuarios', 'action' => 'view', $reporte['Usuario']['id'])); ?></td>
			<td><?= $this->Html->link($reporte['Respuesta']['id'], array('controller' => 'respuestas', 'action' => 'view', $reporte['Respuesta']['id'])); ?></td>
