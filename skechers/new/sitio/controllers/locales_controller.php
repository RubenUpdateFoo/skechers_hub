...
class LocalesController extends AppController
{
	...
	function admin_view($id = null)
	{
		...
		//$this->set('local', $this->Local->read(null, $id));
		 $local = $this->Local->find('first', array('conditions' => array('Local.id' => $id),
   	    											'contain' => array('Tienda', 'Centroscomercial')));
	...
	function admin_add()
	{
		...
		$centroscomerciales = $this->Local->Centroscomercial->find('list', array('fields' => array('Centroscomercial.id', 'Centroscomercial.nombre')));
		$tiendas = $this->Local->Tienda->find('list', array('fields' => array('Tienda.id', 'Tienda.nombre')));
		$this->set(compact('centroscomerciales','tiendas'));
